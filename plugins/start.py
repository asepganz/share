...
async def start_command(client: Bot, message: Message):
    ...
    if len(text) > 7:
        ...
        # UPDATE: Ditambahkan await karena fungsi start_button sekarang async
...
async def not_joined(client: Bot, message: Message):
    # UPDATE: Ditambahkan await karena fungsi fsub_button sekarang async
...
# ... (sisa kode broadcast dan stats tetap sama)
